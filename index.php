    ...
    <article id="estetica-seccion" class="off">
    	<div id="estetica-seccion-titulo" class="titulo-seccion">
		 ...
		 <div class="seccion-contenido">
			...
			<div id="estetica-seccion-php" class="contenido-seleccion">
				<div id="estetica-seccion-boton" class="boton-volver">
					 <?php include $_SERVER['DOCUMENT_ROOT'].'/img/boton.svg';?>
				</div>
			...
			<div class="contacto-contenido">
				<div class="contacto-contenido-redes">
					...
					<div class="instagram-titulo redes">
						<a href="https://www.instagram.com/drturizo/"><i class="fab fa-instagram"></i></a>
					</div>
					<div class="instagram-titulo redes">
						<a href="https://www.facebook.com/drturizo/"><i class="fab fa-facebook"></i></a>
					</div>
					<div class="instagram-titulo redes">
						<a href="https://www.facebook.com/drturizo/"><i class="fab fa-youtube"></i></a>
					</div>
					<div class="instagram-titulo redes">
				...
				<div class="redes-texto whatsapp">
					<a href="https%3A%2F%2Fwa.me%2F541166453915&e=ATPgrz8vzk_wFMSBh9Xuzn5pKvbuQDTWyQmLAITIDEfpo38Z-IEwab1pok7AEfITReYsWDI7UKyN7SFM"><i class="fab fa-whatsapp"></i>&nbsp;what.me<br>(+54-9) 1166453915</a>
				</div>
				<br>
		...
		<div class="seccion-contenido-contenedor">
			...
			<div class="formacion-seccion-parte formacion-seccion-estudios">
		  	...
		  	<ul class="formacion-seccion-listado">
				<li class="formacion-seccion-item">
					<ul>
						<li><strong>Médico</strong></li>
						<li>Facultad de Medicina - Universidad del Sinú</li>
		 	 	...
		 	 	<li class="formacion-seccion-item">
					<ul>
						<li><strong>Concurrencia por 26 meses en el servicio de Cirugía general</strong></li>
						<li>Hospital Interzonal Evita de Lanús</li>
						<li>Lanús Provincia de Buenos Aires (ARGENTINA)</li>
						<li>Año 2012 </li>
					</ul>
				</li>
		  		<li class="formacion-seccion-item">
					<ul>
						<li><strong>Postgrado en Cirugía Plástica, Estética y Reparadora</strong></li>
						<li>Universidad Pontificia Católica de Buenos Aires</li>
...
<script src="/js/miintento.js"></script>
<script src="/js/scrollto/lib/jquery-scrollto.js"></script>
</html>